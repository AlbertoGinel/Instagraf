    ...
    <div className='shadow-sm border-b bg-white sticky top-0 z-50'>
      <div className='flex justify-between max-w-6xl mx-5 lg:mx-auto'>
        ...
        <div className="max-w-xs">
          <div className='relative mt-1 p-3 rounded-mdo'>
            <div className='absolute inset-y-0 pl-3 flex items-center
                            pointer-events-none'>
              <SearchIcon className='h-5 w-5 text-gray-500'/>
            </div>
            <input className='bg-gray-50 block w-full pl-10 sm:text-sm
                              border-gray-300 focus:right-black focus:border-black 
                              rounded-md' 
                  type='text' 
                  placeholder='Search'
                  />
        ...
        <div className='relative navBtn' >
          ...
          animate-pulse text-white'>7</div>
        </div>
        <PlusCircleIcon className='navBtn'/>
        <UserGroupIcon className='navBtn'/>
        <HeartIcon className='navBtn'/>
        
        <img src="https://mir-s3-cdn-cf.behance.net/project_modules/disp/31cd9122564011.56314c9e85467.jpg" 
        alt="grunt"
